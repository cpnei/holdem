...
class ClientPlayer():
    ...
    def render(self, mode='human', close=False):
        ...
        for idx, playerstate in enumerate(state.player_states):
            if playerstate.emptyplayer is False:
    ...
    def _handle_event(self, msg, data):
        ...
        if msg[:len("__new_peer")] == "__new_peer":
            ...
            model_action = self._model.takeExptectedAction(self.get_current_state(), my_seat)
            self._send_action(model_action)

            # my_player_info
            self._last_player = my_seat
    ...
    def doListen(self):
        try:
            ...
            # TODO: find better way to handle exception
